...
class RegisterSendCodeSong extends StatefulWidget {
  static const routeName = '/registerTutor';
  const RegisterSendCodeSong({super.key});

  @override
  State<RegisterSendCodeSong> createState() => _RegisterScreenState();
}

class _RegisterScreenState extends State<RegisterSendCodeSong> {
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(
                width: 330,
                height: 50,
                child: Text("Enviaremos un código al número de teléfono", style: TextStyle(color: Colors.white))
              ),
              Form(
                key: _formKey,
